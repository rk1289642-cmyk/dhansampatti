...
export default async function CPProfile() {
  ...
  const rows = await sql`
    SELECT id, name, email, address, gender, cp_email, pan_card, created_at
      ...
      <main className="page-container">
        ...
        <div className="profile-layout">
          ...
          <div className="card profile-avatar-card">
            ...
            <span className="badge badge-purple profile-role-badge">Channel Partner</span>
          ...
          <div className="card profile-details-card">
            ...
            />
            <ProfileRow
              icon={<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.65 3.24 2 2 0 0 1 3.62 1h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.64a16 16 0 0 0 5.55 5.55l.96-.96a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg>}
              label="Office Email"
              value={user.cp_email ?? '—'}
            />
            <ProfileRow
